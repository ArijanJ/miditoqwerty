...
const std::string lowNotes = "trewq0987654321";
const std::string letterNoteMap = "1!2@34$5%6^78*9(0qQwWeErtTyYuiIoOpPasSdDfgGhHjJklLzZxcCvVbBnm";
const std::string highNotes = "yuiopasdfghj";
//std::string fullScale = "trewq09876543211!2@34$5%6^78*9(0qQwWeErtTyYuiIoOpPasSdDfgGhHjJklLzZxcCvVbBnmyuiopasdfghj";

const std::string velocities = "1234567890qwertyuiopasdfghjklzxc";

const int velocityList[] = {
4,   8,   12,  16,
20,  24,  28,  32,
36,  40,  44,  48,
52,  56,  60,  64,
